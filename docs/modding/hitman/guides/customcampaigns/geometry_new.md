...
> If you'd like an example you can refer to you can load this blender file: [modland.blend](/files/customcampaigns/modland.blend). Note, this reference example is called `Modland`, not `Modtown`.

After installing the add-on, open Blender. 

![blender_new_scene.jpg](/img/customcampaigns/blender_new_scene.jpg)
...
![blender_scaled_cube.jpg](/img/customcampaigns/blender_scaled_cube.jpg)
...
![blender_edit_mode.jpg](/img/customcampaigns/blender_edit_mode.jpg)
...
![blender_extrude.jpg](/img/customcampaigns/blender_extrude.jpg)
...
![blender_move.jpg](/img/customcampaigns/blender_move.jpg)
...
![modtown.jpg](/img/customcampaigns/modtown.jpg)
...
![blender_object_join.jpg](/img/customcampaigns/blender_object_join.jpg)

Select the new collection and on the right panel, select the `Physics` tab, and click the `Add Triangle Mesh Collider` button.  
![blender_physics_panel.jpg](/img/customcampaigns/blender_physics_panel.jpg)
...
![blender_collider_remove_parent.jpg](/img/customcampaigns/blender_collider_remove_parent.jpg)
...
![blender_collision_layer.jpg](/img/customcampaigns/blender_collision_layer.jpg)

In the object panel, select the `Modtown` Collection and switch to the `Collection` properties panel on the right sidebar.  
![blender_collection_properties.jpg](/img/customcampaigns/blender_collection_properties.jpg)

Change the `Physics Data Type` dropdown to `TRIANGLE_MESH`, and the `Physics Collision Type` to `STATIC`.  
![blender_physics_type.jpg](/img/customcampaigns/blender_physics_type.jpg)
...
![blender_base_color_image_texture.jpg](/img/customcampaigns/blender_base_color_image_texture.jpg)
...
![glacierkit_extract_texture_pc_mi.jpg](/img/customcampaigns/glacierkit_extract_texture_pc_mi.jpg)
...
![glacierkit_extract_texture_pc_tex.jpg](/img/customcampaigns/glacierkit_extract_texture_pc_tex.jpg)
...
![blender_add_image_texture.jpg](/img/customcampaigns/blender_add_image_texture.jpg)

Now the mesh has the texture, but we can't see it because the `Shading` mode is set to `Solid`.  
![blender_texture_set.jpg](/img/customcampaigns/blender_texture_set.jpg)
...
![blender_material_preview.jpg](/img/customcampaigns/blender_material_preview.jpg)
...
![blender_top_view.jpg](/img/customcampaigns/blender_top_view.jpg)
...
![blender_uv_map_side_faces.jpg](/img/customcampaigns/blender_uv_map_side_faces.jpg)
...
![blender_export.jpg](/img/customcampaigns/blender_export.jpg)

You'll wind up with a folder of files like this:  
![blender_export_results.jpg](/img/customcampaigns/blender_export_results.jpg)
...
![new_geometry_in_game.jpg](/img/customcampaigns/new_geometry_in_game.jpg)
...
![modtown_select_house.jpg](/img/customcampaigns/modtown_select_house.jpg)
...
![modtown_move_house.jpg](/img/customcampaigns/modtown_move_house.jpg)
...
![modtown_npc_moved.jpg](/img/customcampaigns/modtown_npc_moved.jpg)

After taking out the target, we may need to move the exit as well.  
![modtown_move_exit.jpg](/img/customcampaigns/modtown_move_exit.jpg)

Click the `Exit` node in GlacierKit, and use the Gizmo in ZHMModSDK to move it to a suitable location.  
![modtown_exit_moved.jpg](/img/customcampaigns/modtown_exit_moved.jpg)
...
![navkit_regenerated.jpg](/img/customcampaigns/navkit_regenerated.jpg)
...
![modtown_background.jpg](/img/customcampaigns/modtown_background.jpg)
> Modtown background  

![modtown_tile.jpg](/img/customcampaigns/modtown_tile.jpg)
> Modtown tile  

![modtown_entrance_outside.jpg](/img/customcampaigns/modtown_entrance_outside.jpg)
> Modtown entrance  

![modtown_super_targetman.jpg](/img/customcampaigns/modtown_super_targetman.jpg)
> Modtown Super Targetman  

![modlandia_background.jpg](/img/customcampaigns/modlandia_background.jpg)
> Modlandia background  

![modlandia_tile.jpg](/img/customcampaigns/modlandia_tile.jpg)
> Modlandia tile  
